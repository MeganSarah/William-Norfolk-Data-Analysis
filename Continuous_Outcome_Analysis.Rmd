...
#THIS IS NOT RIGHT? I THINK?-Try AGAIN LATER
...
noro_add_new_var %>% ggplot(aes(x = RateAll - fracinf)) + geom_density()
...
```{r infvalues}
subset(noro_add_new_var$RateAll, noro_add_new_var$fracinf == "inf")
