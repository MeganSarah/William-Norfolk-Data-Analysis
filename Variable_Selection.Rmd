...
drop_unspc_hemi <- clean_year[!(clean_year$Hemisphere == "Unspecified"), ]
...
gg_vs_vomit <- complete_combined_data %>% ggplot(aes(x = gg2c4, y = Vomit, color = gg2c4)) + geom_violin() + geom_jitter(alpha = 0.25) + theme(legend.position = "none")

grid.arrange(gg_vs_casesall, gg_vs_deaths, gg_vs_hosp, gg_vs_meand1, gg_vs_meani1, nrow = 2)

grid.arrange(gg_vs_mediand1, gg_vs_mediani1, gg_vs_obyear, gg_vs_riskall, gg_vs_vomit, nrow = 2)
...
gg_vs_Setting <- complete_combined_data %>% ggplot(aes(x = gg2c4, y = Action1)) + geom_count() 

grid.arrange(gg_vs_action1, gg_vs_country, gg_vs_hemi, gg_vs_path1, nrow = 2)
grid.arrange(gg_vs_season, gg_vs_tras1, gg_vs_Setting, nrow = 2)
